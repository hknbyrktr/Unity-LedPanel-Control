...
#define PIN_DMD_A		12		// D19 / HSPI ise 12.
#define PIN_DMD_B		21		// D21
#define PIN_DMD_CLK		14		// D18_SCK  is SPI Clock if SPI is used / HSPI kullanılıyorsa 14.
#define PIN_DMD_SCLK		16		// D02 / D16
#define PIN_DMD_R_DATA    13	//  SPI kullanılıyorsa D23_MOSI SPI Ana Çıkışı , HSPI kullanılıyorsa 13
